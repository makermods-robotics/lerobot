...
from lerobot.motors.metal.constants import (
    METAL_MOTOR_CONFIG, METAL_JOINT_NAMES, METAL_JOINT_LIMITS_DEG,
)
...
def test_metal_motor_config_ids_and_types():
    assert METAL_JOINT_NAMES == ["joint1","joint2","joint3","joint4","joint5","joint6"]
    assert METAL_MOTOR_CONFIG["joint1"] == (0x01, 0x11, "metal_jlo")
    assert METAL_MOTOR_CONFIG["joint2"] == (0x02, 0x12, "metal_j2")
    assert METAL_MOTOR_CONFIG["joint5"] == (0x05, 0x15, "metal_jhi")
